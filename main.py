...
class Email:
    ...
    def __init__(self, root):
        ...
        self.root.geometry("1000x550+200+50")  ### 200 and 50 are x and y axis from window
        self.root.resizable(False, False)  ###SIZE CANT BE RESIZED first false is width and second is height
